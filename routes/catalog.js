...
// GET request for creating Genre. NOTE This must come before routes that display Genre (uses id).
...
// GET request for creating BookInstance. NOTE This must come before routes that display BookInstance (uses id).
router.get(
  "/bookinstance/create",
